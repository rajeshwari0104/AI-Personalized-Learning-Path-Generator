...
export const getSharedRoadmap = (token) => axios.get(`http://127.0.0.1:8000/api/roadmaps/shared/${token}/`);
export default { register, login, getProfile, generateRoadmap, getRoadmaps, getRoadmap, rateResource, regenerateWeek, getLeaderboard, saveNotes, getSharedRoadmap };
